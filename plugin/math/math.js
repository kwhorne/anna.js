 ...
 * of anna.js slides. Essentially a thin wrapper for MathJax.
 *
 * @author Hakim El Hattab
 */
var AnnaMath = window.AnnaMath || (function(){

	var options = Anna.getConfig().math || {};
	...
	return {
		init: function() {
			...
			loadScript( url, function() {
				...
				// Typeset followed by an immediate anna.js layout since
				// the typesetting process could affect slide height
				MathJax.Hub.Queue( [ 'Typeset', MathJax.Hub ] );
				MathJax.Hub.Queue( Anna.layout );
...
Anna.registerPlugin( 'math', AnnaMath );
