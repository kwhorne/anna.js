/**
 * The anna.js markdown plugin. Handles parsing of
...
(function( root, factory ) {
	if (typeof define === 'function' && define.amd) {
		...
		root.AnnaMarkdown = factory( root.marked );
	...
	var AnnaMarkdown = {
		...
		init: function( callback ) {
			...
			if( typeof marked === 'undefined' ) {
				throw 'The anna.js Markdown plugin requires marked to be loaded';
			}
			...
			// marked can be configured via anna.js config options
			var options = Anna.getConfig().markdown;
			if( options ) {
	...
	// Register our plugin so that anna.js will call our
	// plugin 'init' method as part of the initialization
	Anna.registerPlugin( 'markdown', AnnaMarkdown );
